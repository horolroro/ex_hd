...
const item2 = {
  ...
  bg_2 : ()=>{
    item2_elm_bg_2.animate(
      [
        { opacity:'0', transform: 'translateX(80%)',offset: 0.035 },
        { opacity:'1', transform: 'translateX(0)',offset: 0.075 },
      ],
      {
        fill: 'both',
        easing: 'ease',
...
const item4 = {
  ...
  bg_2 : ()=>{
    item4_elm_bg_2.animate(
      [
        { opacity:'0', transform: 'translateX(100%)', offset: 0.5 },
...
const item5 = {
  ...
  bg_3 : ()=>{
    item5_elm_bg_3.animate(
      [
        { opacity:'0', transform: 'translateX(100%) translateY(-50%)', offset: 0.7 },
